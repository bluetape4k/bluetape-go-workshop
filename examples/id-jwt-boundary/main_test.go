...
func TestNewHTTPServerSetsTimeouts(t *testing.T) {
	...
	server := newHTTPServer("127.0.0.1:8096", handler)
	if server.Addr != "127.0.0.1:8096" {
		t.Fatalf("Addr = %q, want 127.0.0.1:8096", server.Addr)
	}
...
func TestResolveHTTPAddr(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "loopback ipv4", value: "127.0.0.1:8097", want: "127.0.0.1:8097"},
		{name: "localhost", value: "localhost:8097", want: "localhost:8097"},
		{name: "loopback ipv6", value: "[::1]:8097", want: "[::1]:8097"},
		{name: "wildcard host", value: ":8097", wantErr: true},
		{name: "any ipv4", value: "0.0.0.0:8097", wantErr: true},
		{name: "non loopback", value: "192.168.1.10:8097", wantErr: true},
