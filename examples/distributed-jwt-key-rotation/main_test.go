...
func TestNewHTTPServerSetsTimeouts(t *testing.T) {
	...
	server := newHTTPServer("127.0.0.1:8099", handler)
	if server.Addr != "127.0.0.1:8099" {
		t.Fatalf("Addr = %q, want 127.0.0.1:8099", server.Addr)
	}
...
func TestResolveHTTPAddr(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "loopback ipv4", value: "127.0.0.1:8100", want: "127.0.0.1:8100"},
		{name: "localhost", value: "localhost:8100", want: "localhost:8100"},
		{name: "loopback ipv6", value: "[::1]:8100", want: "[::1]:8100"},
		{name: "wildcard host", value: ":8100", wantErr: true},
		{name: "any ipv4", value: "0.0.0.0:8100", wantErr: true},
		{name: "non loopback", value: "192.168.1.10:8100", wantErr: true},
