...
PostgreSQL과 Redis를 시작한 뒤 loopback-only Gin service를 실행합니다.
...
[예제 README](examples/audited-order-workflow-outbox/README.ko.md)에는 create,
confirm, replay, pagination history, detail, cancel, conflict를 그대로 실행할 수 있는
POST JSON command와 Redis 장애/lease recovery runbook이 있습니다.
