...
| 7 Docs/release/evidence | README pair, root table, diagram assets, validation | 0 | 0 | 0 | 0 | EN/KO README pair and root rows use `English | 한국어`; diagram SVG/PNG and Graphviz evidence exist. |
